...
class Direction(Enum):
    """Enum class for representing directions in the game."""
    RIGHT = 1
    LEFT = 2
    UP = 3
    DOWN = 4
...
class SnakeGameAI:
    """
    A class that implements the Snake game with AI capabilities.
    """
    ...
    def is_collision(self, pt=None):
        ...
        Args:
            pt (Point, optional): The point to check. Defaults to None (checks the head).
